...
class _DaftarKlaimAktifPageState extends State<DaftarKlaimAktifPage> {
  // Dummy data klaim aktif yang strukturnya disesuaikan agar tidak kosong
  ...
  // Widget untuk list item klaim yang lebih compact
  ...
  // Fallback UI Pencegahan jika data dari Supabase mendadak gagal dimuat/kosong
